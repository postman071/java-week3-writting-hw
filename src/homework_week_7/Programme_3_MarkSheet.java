...
/**
 * Write a java program to input the student Name, roll No, and theree subjects Maths,Science and
 * English marks (marks is between 0 to 100 and if it is out of range print error message "Invalid
 * Input,Marks should between 0 to 100") and find out total,percentage and result.
 * if he is pass or fails on basis of percentage(pass>=35) and also give them grade if
 * %> =80A+, %> =60 A, %>50B, %> =35C And print Mark Sheet in FOllowing format
